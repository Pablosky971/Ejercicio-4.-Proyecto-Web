...
// El objeto Servlet será el mismo para todos los clientes.
...
public class PrimerServlet extends HttpServlet {
   ...
   // HTTP
	...
	// Los objetos Request y Response también son creados mediante IoC (inverisón del control), pero en este caso el ciclo de vida que aplica Tomcat a estos objetos es que vivirán durante toda una
	// petición HTTP y luego morirán :( :(
	
	// El otro concepto que se aplica aquí, es el de ID (Inyección de dependencias).
