...
public class FormularioJSPServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// Podemos decir al servlet donde queremos ir para mostrar la información
		...
		// Si se quiere guardar info para un usuario durante todo su trayecto por la aplicación, se debe usar la session.
		request.getSession().setAttribute("nombre", nombre);

		// Ejecutamos acción de ir
